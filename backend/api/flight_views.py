    ...
    with db.session.no_autoflush:
        ...
        for assignment in assignments:
            ...
            if person_type == "Passenger":
                person = db.session.get(Passenger, assignment.seater_id)
                ...
                person = db.session.get(Pilot, assignment.seater_id)
                ...
                person = db.session.get(CabinCrew, assignment.seater_id)
